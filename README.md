...
3. En el panel izquierdo, desplegar la carpeta `src` y navegar por los paquetes hasta abrir el archivo `llanquihuetour/app/Main.java`.
4. Hacer clic derecho sobre cualquier parte del código dentro del archivo `Main.java`.
5. Seleccionar la opción **Run 'Main.main()'** (o presionar el botón verde de "Play" al lado del método main).
6. Los resultados y las validaciones se mostrarán en la consola inferior del programa.
